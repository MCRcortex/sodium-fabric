...
public class RegionManager {
    ...
    public int createSectionIndex(BatchedUploadStreamer uploadStream, int sectionX, int sectionY, int sectionZ) {

    }

    public void removeSectionIndex(BatchedUploadStreamer uploadStream, int sectionX, int sectionY, int sectionZ, int sectionIdx) {
