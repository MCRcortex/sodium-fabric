...
public class TEMPORARY_accelerationSystem {
    ...
    private record BlasData(ChunkSectionPos pos, VVkAccelerationStructure blas) {
        public void free() {
            blas.free();
        }
    }
    ...
    private void tickRebuilds() {
        ...
        List<VVkBuffer> toFree = new LinkedList<>();
        ...
        try (MemoryStack stack = MemoryStack.stackPush()){
            ...
            });
            {
                ...
                while (posIter.hasNext()) {
                    ...
                    var oldBlas = loadedSections.put(pos, new BlasData(pos, blas));
